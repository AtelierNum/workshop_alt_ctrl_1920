...
Depuis que le Madness Circus a ouvert, il est déconseillé de rentrer seul le soir. Des gens racontent avoir entendu des rires de clown provenant de la forêt, d’autres affirment avoir vu une petite fille à robe blanche sous un lampadaire. Une rumeur dirai même qu’un monstre de foire du cirque se serait échappé pour se réfugier dans la forêt. Madness circus est un jeu immersif qui se joue dans le noir. Comme vous pouvez vous en douter, ce jeu d’arcade est aussi un jeu d’horreur. Madness Circus utilise trois mécaniques de jeu différentes: tourner le guidon, freiner et klaxonner. Le son est omniprésent dans le jeu, il renforce l’immersion et développe le stresse chez le joueur.

Le joueur sera immergé dans un univers sombre et terrifiant, il se retrouve poursuivie par trois monstres, la petite fille, le clown et le loup-garou. seul moyen pour lui de s'enfuir, un vélo. Chaque monstre a des faiblesses, au joueur de les trouver et de les utiliser à bonne escient.

La petite fille a peur du noir (le joueur doit éteindre la lumière du vélo), le clown déteste le son de la sonnette (faire sonner la sonnette) et il faut a tout prix éviter le loup garou (tourner le guidon).

Tout au long du jeu, le joueur apprend du passé des monstres ce qui va lui servir pour sa survie.
...
### Installer les capteurs sur le vélo :

![Circus%20Madness/schema_velo.jpg](Circus%20Madness/schema_velo.jpg)

### Créer un détecteur de direction :

bien faire attention à ce que l'aluminium de la roue principale touche les capteurs (poteaux) gauche et droit lorsque vous tournez le guidon.

![Circus%20Madness/alumi.jpg](Circus%20Madness/alumi.jpg)

### Faire les branchements selon ce schéma :

![Circus%20Madness/schema_electro.jpg](Circus%20Madness/schema_electro.jpg)

# Code

### Rédiger le code ci-dessous (et de le comprendre ;) ) :
